...
export const PROVIDERS: ProviderConfig[] = [
  ...
  },
  {
    id: "gemini",
    label: "Gemini",
    authLabel: "Usage visible in Gemini settings",
    command: null,
  ...
  },
  {
    id: "grok",
    label: "Grok",
    authLabel: "Grok Build CLI setup",
    command: null,
    connectUrl: "https://x.ai/news/grok-build-cli",
    actionLabel: "CLI",
    available: false,
  },
  {
    id: "cursor",
    label: "Cursor",
    authLabel: "Usage visible in dashboard",
    command: null,
  ...
  },
  {
    id: "kimi",
    label: "Kimi K2",
    authLabel: "Kimi Code CLI setup",
    command: null,
    connectUrl: "https://moonshotai.github.io/kimi-cli/en/guides/getting-started.html",
    actionLabel: "CLI",
    available: false,
  },
  {
    id: "glm",
    label: "GLM",
    authLabel: "Coding plan setup",
    command: null,
    connectUrl: "https://docs.z.ai/devpack/quick-start",
    actionLabel: "Setup",
    available: false,
  },
];
